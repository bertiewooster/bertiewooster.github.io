...
<img alt="Jeremy presenting MolsMatrixToGridImage in Finding Tautomers talk at North American RDKit User Group Meeting" style="width:400px; height:181px" src="/images/Jeremy-in-front-of-Finding-Tautomers-MolsMatrixToGridImage-cropped.png">

### Finding Tautomers

**North American RDKit User Group Meeting** · April 2025 · *Talk*

A comparison of cheminformatics tautomer-generation algorithms and of how well InChI provides a single representation across tautomers.

[Slides](https://docs.google.com/presentation/d/1-gg4jf4djZs9CdPhQR4RPoqrsB0wZeW8V6ZeHoYADK4/edit?usp=sharing) · [Blog with code]({% post_url 2024-05-01-Tautomer-Sources-Comparison %})

### Prioritizing Drug-Like ChEMBL Compounds Within Target Profiles

**marimo Community Call** · April 2026 · *Invited talk*

A compound-first approach to drug discovery that treats activity across multiple targets as a potential advantage to prioritize.

[Interactive marimo notebook](https://molab.marimo.io/notebooks/nb_pFcNtsNCS1Qy2Ua4riPzqK) · [Blog with original code]({% post_url 2026-01-05-ChEBML-database %})
...
### [React app tic-tac-toe game](https://bertiewooster.github.io/react_tic_tac_toe/)
